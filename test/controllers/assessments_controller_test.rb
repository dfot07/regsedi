...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { act_id: @assessment.act_id, fecha_cancelacion: @assessment.fecha_cancelacion, fecha_constitucion: @assessment.fecha_constitucion, genera_gravamen: @assessment.genera_gravamen, posee_gravamen: @assessment.posee_gravamen, tipo_genera_gravamen: @assessment.tipo_genera_gravamen, tipo_gravamen: @assessment.tipo_gravamen, user_id: @assessment.user_id } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { act_id: @assessment.act_id, fecha_cancelacion: @assessment.fecha_cancelacion, fecha_constitucion: @assessment.fecha_constitucion, genera_gravamen: @assessment.genera_gravamen, posee_gravamen: @assessment.posee_gravamen, tipo_genera_gravamen: @assessment.tipo_genera_gravamen, tipo_gravamen: @assessment.tipo_gravamen, user_id: @assessment.user_id } }
